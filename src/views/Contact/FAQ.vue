<template>
  <div class="w-full flex item-center justify-center mt-20 mb-20">
    <div class="space-y-4 w-3/4 sm:w-1/2">
...
export default {
  ...
  mounted() {
    if (this.$store.state.Lang) {
      document.title = "الأسئلة الشائعة | H&A";
    } else {
      document.title = "FAQ | H&A";
    }
  },
};
</script>
